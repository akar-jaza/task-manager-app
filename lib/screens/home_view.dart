...
import 'package:task_manager_app/screens/tasks_screen/tasks_view.dart'; // Keep only TasksView
...
class HomeView extends StatelessWidget {
  ...
  // Only 2 pages: Tasks and Add Task
  final List<Widget> pages = [TasksView(), AddTaskView()];
